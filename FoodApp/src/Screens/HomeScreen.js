    ...
    return (
        <View className="flex-1 bg-white">
            ...
            >
                ...
                <View className="mx-4 sapce-y-2 mb-2">
                    <Text style={{fontSize: hp(1.8)}} className="text-neutral-600">Hello, Christian!</Text>
                    <View>
                    ...
                    <Text style={{fontSize: hp(3.8)}} className="text-semibold text-neutral-600">
                        <Text>stay </Text>
                        <Text className="text-amber-400">at home</Text>
                    </Text>
                </View>
